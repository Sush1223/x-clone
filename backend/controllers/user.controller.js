...
export const followUnfollowUser = async (req, res) => {
  try {
    ...
    if (isFollowing) {
      ...
      // to do - send the id of the user as a response
...
export const getSuggestedUsers = async (req, res) => {
  try {
    ...
    // get the users which is not authenticated and getting 10 such users
    ...
    // getting first 4 filtered users
    const suggestedUsers = filteredUsers.slice(0, 4);

    // making the suggested users password as null
